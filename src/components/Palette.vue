<template>
    <div v-show="initialized" class="absolute bottom-32 right-5 mb-16">
        <div class="p-5 w-1 h-4 rounded-lg border-4 border-gray transparent-swatch"></div>
    </div>
    <div v-show="initialized" class="absolute bottom-32 right-5 mb-16 z-10">
    ...
    <div v-show="initialized" class="absolute h-36 bottom-5 right-0 m-5 z-10 rounded border bg-white overflow-auto scrollbar scrollbar-thumb-stone-200 scrollbar-track-while scrollbar-thumb-rounded-full scrollbar-w-3">
