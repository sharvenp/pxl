...
export class Line extends Tool {
  ...
  constructor(iApi: InstanceAPI) {
    ...
    this._thicknessProperty = new SliderProperty(
      "Thickness",
      1,
      5,
      toolState?.thickness ?? 1,
      "px",
    );

    this._toolProperties = [this._thicknessProperty];
    ...
    if (color && grid && cursor) {
      ...
      if (
        ...
        zippedCoords.forEach((coordPairs) => {
          this._drawGraphic
            .moveTo(coordPairs.c1.x, coordPairs.c1.y)
